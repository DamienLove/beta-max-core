...
// Optimized: Memoized project selector to prevent re-renders when form state changes
const ProjectSelect = React.memo(({ projects, value, onChange }: {
    projects: Project[],
    value: string,
...
// Optimized: Memoized version selector to prevent re-renders when form state changes
const VersionSelect = React.memo(({ versions, value, onChange }: {
...
const FeedbackForm = () => {
    ...
    // Optimized: Stable handlers for inputs to prevent unnecessary re-renders of memoized components
